...
For full descriptions of every script and algorithm see **<HYPERLOAD_Description.pdf>**.
...
1. Launches the full PyQt6 launcher window
1. Lets you open any script as a floating panel from the tree sidebar
...
Scripts are released for free personal and educational use.
